...
class _HomeMobileState extends State<HomeMobile> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              dataBox(
                title: AppString.appName11,
              ),
              const SizedBox(
                width: 5,
              ),
              dataBox(
                title: AppString.appName12,
              ),
            ],
          ),
        ],
  ...
  _saveLocalImage() async {
    RenderRepaintBoundary boundary = imageGlobalKey.currentContext!.findRenderObject() as RenderRepaintBoundary;
